...
**NOTE: Depending on the user's choice, they can modify the behaviour and name of the agent. To make these changes, user must visit lines 75-88 in agent.py to directly alter the behaviour and name of the agent using natural language.**
